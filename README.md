...
##### VLC
You can use VLC to view the livestream. You will need the same link as is described for QGroundControl. Important to know is that VLC has a standard buffer time of ± 2 seconds. This means we don't recommend to use VLC.
