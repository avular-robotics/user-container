...
RUN git clone --depth 1 --branch v2.55.1 https://github.com/IntelRealSense/librealsense.git librealsense && \
    cd librealsense && \
...
RUN git clone https://github.com/IntelRealSense/realsense-ros.git -b 4.55.1 
